...
// assets
import User1 from 'assets/images/users/My foto.jpeg';
...
export default function ProfileSection() {
  ...
  return (
    ...
    <Stack direction="row" spacing={2} alignItems="center">
      ...
      <Stack spacing={0.5}>
        <Typography variant="h4">Diksha Dewangan</Typography>
        <Typography variant="subtitle2">Customer(541)</Typography>
        <Typography variant="subtitle2">diksha.dewangan2023@ssipmt.com</Typography>
      </Stack>
    </Stack>
  </Box>
                      {/* <OutlinedInput
