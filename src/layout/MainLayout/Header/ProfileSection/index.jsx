                  ...
                  <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                    <Box sx={{ p: 2, pb: 0 }}>
                      ...
                      <img
                       ...
                       />
                        ...
                        <Stack spacing={0.5} >
                          <Typography variant="h4">Bhavik Thakkar</Typography>
                        <Typography variant="subtitle2">Service Provider (540)</Typography>
                        <Typography variant="subtitle2">bhavikthakkar2004@gmail.com (540)</Typography>
                      </Stack>
                       </Stack>
                      {/* <OutlinedInput
                    ...
                    >
                      ...
                      >
                        ...
                        to="/provider/profile"
                        onClick={handleClose} sx={{ borderRadius: `${borderRadius}px` }} selected={selectedIndex === 1}>
                          <ListItemIcon>
