                ...
                {open && (
                  <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                    <Box sx={{ p: 2, pb: 0 }}>
                      ...
                      <Stack>
                          <Typography variant="h4">Alka Kushwaha</Typography>
                          <Typography component="span" variant="h4" sx={{ fontWeight: 400 }}>
                            
                          </Typography>
                        
                        <Typography variant="subtitle2">Customer (545)</Typography>
                        <Typography variant="subtitle">alka.kushwaha2023@ssipmt.com</Typography>
                      </Stack>
                      </Stack>
                      {/* { <OutlinedInput */}
