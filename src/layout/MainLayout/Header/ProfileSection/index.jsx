...
// assets
import User1 from 'assets/images/LekhaPhoto.jpeg';
...
export default function ProfileSection() {
  ...
  return (
    ...
    <Stack direction="row" spacing={2} alignItems="center">
      ...
      <Stack spacing={0.5}>
        <Typography variant="h4">Lekha Sahu</Typography>
        <Typography variant="subtitle2">Service Provider (535)</Typography>
        <Typography variant="subtitle2">lekhasahu615@gmail.com</Typography>
      </Stack>
    </Stack>
  </Box>
                      {/* <OutlinedInput
