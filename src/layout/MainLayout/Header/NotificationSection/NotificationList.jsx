...
// assets
import { IconBrandTelegram,IconEPassport,IconSettings, IconBuildingStore, IconMailbox, IconPhoto,IconCalendarFilled } from '@tabler/icons-react';
  ...
  return (
    <List sx={{ width: '100%', maxWidth: { xs: 300, md: 330 }, py: 0 }}>
      <ListItemWrapper>
        ...
        >
          <ListItemAvatar>
            <Avatar alt="" src={IconEPassport} />
          </ListItemAvatar>
          <ListItemText primary="Launch Admin" />
        </ListItem>
      ...
      <ListItemWrapper>
        ...
        >
          ...
          <ListItemText primary={<Typography variant="subtitle1">Event Today</Typography>} />
        </ListItem>
        <Stack spacing={2} sx={containerSX}>
      ...
      <ListItemWrapper>
        ...
        >
          ...
          <ListItemText primary={<Typography variant="subtitle1">Setting</Typography>} />
        </ListItem>
