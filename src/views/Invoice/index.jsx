...
/*
const initialData = [
    { id: 1, name: 'Aarav Sharma', mobile: '9876543210', email: 'aarav.s@example.com', age: 28, receivedDate: '2025-07-15' },
    { id: 2, name: 'Diya Patel', mobile: '9123456780', email: 'diya.p@example.com', age: 34, receivedDate: '2025-07-12' },
    { id: 3, name: 'Rohan Gupta', mobile: '9988776655', email: 'rohan.g@example.com', age: 45, receivedDate: '2025-06-28' },
];
*/
...
const CustomerInvoiceListPage = () => {
    ...
    const columns = [
        ...
        { key: 'mobile', label: 'Mobile Number', isSortable: true },
        { key: 'email', label: 'Email', isSortable: true },
        { key: 'age', label: 'Age', isSortable: true },
        { key: 'receivedDate', label: 'Received date', isSortable: true },
        { key: 'action', label: 'Action', isSortable: false },
    ];
                    ...
                    <div className="card-body">
                        <div className="controls-wrapper">
                            <div className="show-entries">
                                ...
                                <select id="entries" value={entriesToShow} onChange={(e) => setEntriesToShow(Number(e.target.value))}>
                        ...
                        <div className="table-responsive">
                            <table className="invoice-table">
                                <thead>
                                    <tr>
                                        {columns.map(col => (
                                            <th key={col.key} onClick={() => col.isSortable && requestSort(col.key)} className={col.isSortable ? 'sortable' : ''}>
                                                {col.label}
                        ...
                        <div className="pagination-wrapper">
                            <div className="pagination-info">Showing {startEntry} to {endEntry} of {totalEntries} entries</div>
