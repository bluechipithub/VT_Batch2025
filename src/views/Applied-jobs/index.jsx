...
const InvoiceListPage = () => {
  ...
  const columns = [
    ...
    { key: 'Service Request Id', label: 'Service Request Id', isSortable: true },
    { key: 'Service Description', label: 'Service Description', isSortable: true },
    { key: 'Submitted date', label: 'Submitted date', isSortable: true },
    { key: 'Application Status', label: 'Application Status', isSortable: true },
    { key: 'Closed date', label: 'Closed date', isSortable: true },
    { key: 'Amount', label: 'Amount', isSortable: true },
    { key: 'Payment Status', label: 'Payment Status', isSortable: true},
  ];
